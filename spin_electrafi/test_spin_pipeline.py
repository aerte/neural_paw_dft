...
from model.data_utils import DensityDataset, collate_fn
from model.ELECTRAFI import ELECTRAFI
from tools.density_conversions import get_density
from utils.train_helper_funcs import set_all_paths, set_all_seeds
...
def build_config() -> dict:
    ...
    with open(config["escaip_cfg_path"]) as f:
