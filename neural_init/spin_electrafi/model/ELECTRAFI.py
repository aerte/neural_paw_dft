...
from neural_init.spin_electrafi.model.data_utils import DensityDataset, DensityStream, _dl_worker_init, collate_fn
from neural_init.spin_electrafi.model.escaip.EScAIP import EScAIPBackbone
from neural_init.spin_electrafi.model.loss import DensityLoss, SpinDifferenceLoss
from neural_init.spin_electrafi.model.model_utils import PWGrid, struc_from_gaussians_keops
from neural_init.spin_electrafi.tools.density_conversions import cd_to_chgcar_mat
from neural_init.spin_electrafi.tools.valence_picker import pick_valence_slots, required_valence_slots
from neural_init.spin_electrafi.tools.visualization import (
    create_chg_delta,
    plot_atoms_with_displacements,
    plot_atoms_with_gaussian_shapes,
)
from neural_init.spin_electrafi.utils.model_handling import ModelIO
from neural_init.spin_electrafi.utils.train_helper_funcs import set_optimizer, set_optimizers_mixed
...
class ELECTRAFI(L.LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from neural_init.spin_electrafi.tools.atom_tools_mpfull import VALENCE_OPTIONS, valence_dict
