...
from .utils.fairchem_graph import generate_graph
...
class EScAIPBackbone(nn.Module):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # use_pbc_single is dataclasses.MISSING when absent from the yaml (configs.py quirk),
        # which is truthy; kept as-is so the graph construction matches the trained models.
