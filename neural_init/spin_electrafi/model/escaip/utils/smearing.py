"""Distance smearing bases, vendored verbatim from fairchem-core 1.10.0
(src/fairchem/core/models/scn/smearing.py). MIT License, Copyright (c) Meta Platforms,
Inc. and affiliates -- see LICENSE.fairchem in the escaip package directory.
"""
