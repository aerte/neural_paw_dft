...
from src.paw_basis_transform import set_l_channel_overrides
from src.augnet_model import Z_TO_SCHEMA
from src.run_paw_chgcar import detect_lmaxmix, resolve_lmaxmix
...
def collect(run_dir: Path) -> dict:
    ...
    for npz_path in npzs:
        ...
        from src.run_paw_chgcar import parse_aug_from_file
